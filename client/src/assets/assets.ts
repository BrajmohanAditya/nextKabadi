...
import normal_recyclables from "./normal_recyclables.png";
import large_appliances from "./large_appliances.png";
import small_appliances from "./small_appliances.png";
import it_E_waste from "./it_E_waste.png";
import vehicle_scrap  from "./vehicle_scrap.png";
...
export const categoriesData = [
    { slug: "Normal Recyclable", name: "Normal Recyclable", image: normal_recyclables },
    { slug: "Large Appliances", name: "Large Appliances", image: large_appliances },
    { slug: "Small Appliances", name: "Small Appliances", image: small_appliances },
    { slug: "IT E-waste", name: "IT E-waste", image: it_E_waste },
    { slug: "Vehicle Scrap", name: "Vehicle Scrap", image: vehicle_scrap },


];

export const heroSectionData = {
    description: "Schedule hassle-free doorstep scrap collection for paper, plastic, metal & e-waste. Fair digital weighing & instant cash payout.",
    hero_image: hero_bg,
    hero_features: [
        { icon: TruckIcon, title: "Free Pickup", desc: "Doorstep collection" },
        { icon: LeafIcon, title: "100% Eco-Recycle", desc: "Zero landfill policy" },
        { icon: ClockIcon, title: "Digital Scale", desc: "Accurate weighing" },
        { icon: ShieldCheckIcon, title: "Instant Payout", desc: "Cash / UPI on pickup" },
    ],
};
...
export const appPromoBannerData = {
    title: "Schedule scrap pickup in minutes",
    description: "Download the Nextkabadi app for instant pickup booking, real-time tracking, and fair digital rates delivered right to your doorstep.",
};

export const footerData = {
    brand: {
        name: "Nextkabadi",
        description: "Hassle-free doorstep scrap pickup and recycling. Turn your waste into cash while contributing to a greener planet.",
        socials: [
